...
const HomeHeader = () => {
  return (
    <div>
      ...
      <div></div>
      <div>
        <h1 className="text-[40px] font-extrabold text-center my-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 max-w-[95%] mx-auto gap-5 md:max-w-[80%]">
        <div className="hover:opacity-80 cursor-pointer">
          <h1 className="text-2xl font-extrabold text-red-700 bg-black p-2">Articles</h1>
          <img
        ...
        <div className="hover:opacity-80 cursor-pointer">
          <h1 className="text-2xl font-extrabold text-red-700 bg-black p-2">Free Programs</h1>
          <img
        ...
        <div className="hover:opacity-80 cursor-pointer">
          <h1 className="text-2xl font-extrabold text-red-700 bg-black p-2">Online Coaching</h1>
          <img
